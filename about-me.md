---
description: 남홍식 / Hongsik-Nam / robbins.hs@gmail.com
---
...
1. **항로표지 정보의 스마트화 전략 연구용역\(2019.12\)**
...
![Docker&#xB97C; &#xC774;&#xC6A9;&#xD55C; OpenAPI &#xAD00;&#xB9AC;](.gitbook/assets/3.png)
...
3. Scale\(축척별\) 이미지 저장
4. Openlayers를 이용한 랜더링한 이미지 지도에 표출![](.gitbook/assets/2.png)

결과 :

브라우저 마다 랜더링 하지 않고 랜더링된 이미지를 가시화 하기때문에 속도가 크게 개선.

차세대 수로제품\(S-100\) 관리 체계 구성도![](.gitbook/assets/4.png)

프로젝트별

시스템 구성도

한국형 e-Navigation 서비스를 위한 핵심 기술연구 개발 구성도![](.gitbook/assets/5.png)
